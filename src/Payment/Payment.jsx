        ...
        <div className="payment_box">
          <div>
            ...
            <div className="payment_selectbox">
              <div>
                <select className="payment_select" onChange={handleSelect} value={Selected}>
                  {selectList.map((item) => (
          ...
          <div className = "payment_check">
            <div className = "payment_checkbox">
              <input type='checkbox'name='agree' value='agree'/>예약 이용약관에 동의 하시겠습니까?
            </div>
            <button className = "payment_checkbutton">
              결제하기
            </button>
          </div>
        </div>
  ...
  return (
    <div>
      <div className="payment_account">
        <div className="payment_accounttext">아래의 계좌 중 선택하여 이체해주세요.</div>
        <div className="payment_accounttext">국민) 937702-00-117772 이진수</div>
        <div className="payment_accounttext">신한) 110-454-239550 이진수</div>
        <div className="payment_accounttext">기업) 059-096815-01-010 이진수</div>
      </div>
    </div>
  )
}
